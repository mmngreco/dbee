...
latex_documents = [
    (master_doc, 'dbee.tex', 'dbee Documentation',
     'COM', 'manual'),
]
...
man_pages = [
    (master_doc, 'dbee', 'dbee Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dbee', 'dbee Documentation',
     author, 'dbee', 'One line description of project.',
     'Miscellaneous'),
]
